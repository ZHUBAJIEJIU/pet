...
class PetChat(QWidget):
    ...
    def onActivated(self, text):
        self.clear_msg()
        self.chat_messages.pop()
        if text =='出去玩': self.chat_messages.append(self.story[0])
        elif text =='云朵精灵':self.chat_messages.append(self.story[1])
        elif text =='冒险游戏':self.chat_messages.append(self.story[2])
